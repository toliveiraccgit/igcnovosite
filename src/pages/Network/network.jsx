        ...
        <div className="bannerText">
          <div className="theContainer">
            ...
            <p className="description">
              Nossa rede de parceiros que através de suas conexões e iniciativas
              indicam e acessam empresários para a igc partners.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="containerForm">
        <div className="theContainer">
          <div className="leftContainer">
            ...
            <p>
              Preencha o formulário ao lado ou envie um email para{" "}
              <span>felipe.petersen@igcp.com.br</span> e fale com nosso sócio
            </p>
          </div>
          <div className="form">
            <form action="">
